...
// get classroom which is created by me api
...
router.get('/getclassbyid/:classid', authTokenHandler, async (req, res) => {
    ...
    try {
        // TODO : add one more condition   -> if (classroom.owner == req.userid || classroom.students.includes(req.userid)) then only { populate posts } 
...
router.post('/verify-otp', authTokenHandler, async (req, res) => {
    ...
    try {
        ...
        //if you are already join that classrooom 
